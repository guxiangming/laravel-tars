...
class Config
{
    ...
    public static function fetch($tarsregistry, $appName, $serverName,$configName, $logLevel = 'INFO')
    {
        ...
        $configServant->loadConfig($appName, $serverName,$configName, $configtext);
